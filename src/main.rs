...
pub async fn login_handler(users: Users, body: LoginRequest) -> WebResult<impl Reply> {
    ...
    println!("{} - fixadm_service INFO - START JWT usidhex UID {}", login_date, &transaction_id);
...
fn init_users() -> HashMap<String, User> {
    ...
    map.insert(
        ...
        User {
            ...
            identity: String::from("ephemeral@fixadm.auth.domain.99_map"),
    ...
    map.insert(
        ...
        User {
            ...
            identity: String::from("observiceadmin@authorized.domain.99_map"),
